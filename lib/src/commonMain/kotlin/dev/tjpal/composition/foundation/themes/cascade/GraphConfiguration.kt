...
import dev.tjpal.composition.foundation.themes.tokens.GraphConnectorCrossTokens
...
fun createGraphConfiguration(): GraphTokens {
    return GraphTokens(
        ...
        connector = GraphConnectorTokens(
            connectedDot = GraphConnectorDotTokens(DefaultConnectedDotColor, radius = 6.dp, filled = true),
            connectingDot = GraphConnectorDotTokens(DefaultConnectedDotColor, radius = 6.dp, filled = true),
